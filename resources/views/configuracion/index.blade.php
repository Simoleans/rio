...
<div class="col-md-8 offset-2">
  <div class="card">
    <div class="card-header">
      <h4 class="card-title" id="basic-layout-form">Configuracion</h4>
    </div>
    @csrf
    <hr/>
        ...
        <div class="card-content">
          <div class="px-3">
              ...
              <ul class="list-group list-group-flush">
                ...
                <!--<a href="{{route('configuracion.show',['id' => $a->id])}}" class="btn btn-raised btn-success btn-min-width mr-1 mb-1"><i class="fa fa-eye" title="Ver"></i></a>-->
                <a href="{{route('configuracion.edit',['id' => $a->id])}}" class="btn btn-raised btn-warning btn-min-width mr-1 mb-1"><i class="fa fa-edit" title="Editar"></i></a>
