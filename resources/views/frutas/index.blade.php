    ...
    <div class="card-content">
      <div class="card-body card-dashboard table-responsive">
        <table class="table table-striped table-bordered default-ordering dataTable">
          ...
          @foreach($frutas as $a)
           <tr>
             	<td class="text-center">{{$a->nombre_fruta}}</td>
                ...
                <a class="btn btn-raised btn-danger btn-min-width mr-1 mb-1 delete" data-url="{{route('frutas.destroy',['id' => $a->id])}}"><i class="fa fa-trash" title="Eliminar"></i></a>
             	</td>
           </tr>
	        @endforeach
          </tbody>
