    ...
    <div class="col-12">
      ...
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Devoluciones Registradas</h4>
          <p class="card-text">todos las devolucion.</p>
        </div>
        <div class="card-content">
          <div class="card-body card-dashboard table-responsive">
            <table class="table table-striped table-bordered default-ordering dataTable">
              ...
              <tbody>
              @foreach($devolucion as $a)
               <tr>
	               	<td class="text-center">{{$a->maquina->marca}}</td>
	               	<td class="text-center">{{$a->maquina->modelo}}</td>
                  <td class="text-center">{{$a->horas}}</td>
	               	<td class="text-center">
	               		<a href="{{route('devolucion.show',['id' => $a->id])}}" class="btn btn-raised btn-success btn-min-width mr-1 mb-1"><i class="fa fa-eye" title="Ver"></i></a>
