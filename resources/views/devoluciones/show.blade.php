...
<section id="about">
  <div class="row">
    <div class="col-12">
      <div class="content-header">Devolución</div>
    </div>
  </div>
  <div class="row">
    <div class="col-sm-12">
      ...
      <div class="card">
        <div class="card-header">
          <h5>Maquina <!-- <button type="button" id="cambiar_status" class="pull-right btn btn-danger" data-url="{{route('arriendo.eliminar',['id' => $devolucion->id])}}">Eliminar</button> -->
            <a href="{{route('reporte.devolucion',['id' => $devolucion->id])}}" id="reporte" target="_blank" class="pull-right btn btn-danger"><i class="fa fa-print"></i> Reporte</a>
          </h5>
              ...
              <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                <ul class="no-list-style">
                  <li class="mb-2">
                    ...
                    <span class="line-height-2 d-block overflow-hidden">{{$devolucion->maquina->marca}}</span>
                  </li>
                  <li class="mb-2">
                    <span class="primary text-bold-500"><a><i class="ft-home font-small-3"></i> Modelo</a></span>
                    <span class="line-height-2 d-block overflow-hidden">{{$devolucion->maquina->modelo}}</span>
                  </li>
                </ul>
                <ul class="no-list-style">
                  <li class="mb-2">
                    <span class="primary text-bold-500"><a><i class="ft-home font-small-3"></i> Horas</a></span>
                    <span class="line-height-2 d-block overflow-hidden">{{$devolucion->horas}}</span>
                  </li>
              ...
              <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                <ul class="no-list-style">
                  <li class="mb-2">
                    ...
                    <span class="line-height-2 d-block overflow-hidden">{{$devolucion->maquina->ano_maquina}}</span>
                  </li>
                  <li class="mb-2">
                    <span class="primary text-bold-500"><a><i class="ft-home font-small-3"></i> Series</a></span>
                    <span class="line-height-2 d-block overflow-hidden">{{$devolucion->maquina->serie}}</span>
                  </li>
                   <li class="mb-2">
                    <span class="primary text-bold-500"><a><i class="ft-home font-small-3"></i> Nombre</a></span>
                    <span class="line-height-2 d-block overflow-hidden">{{$devolucion->maquina->nombre}}</span>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                <ul class="no-list-style">
                  <li class="mb-2">
                    ...
                    <span class="line-height-2 d-block overflow-hidden">{{$devolucion->maquina->propietario->rut}}</span>
                  </li>
                  <li class="mb-2">
                    <span class="primary text-bold-500"><a><i class="ft-home font-small-3"></i> Razón Social</a></span>
                    <span class="line-height-2 d-block overflow-hidden">{{$devolucion->maquina->propietario->r_social}}</span>
                  </li>
                </ul>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                <ul class="no-list-style">
                  <li class="mb-2">
                    ...
                    <span class="line-height-2 d-block overflow-hidden">{{$devolucion->maquina->propietario->direccion}}</span>
                  </li>
                  <li class="mb-2">
                    <span class="primary text-bold-500"><a><i class="ft-home font-small-3"></i> Comuna</a></span>
                    <span class="line-height-2 d-block overflow-hidden">{{$devolucion->maquina->propietario->comuna->comuna}}</span>
                  </li>
                </ul>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                <ul class="no-list-style">
                  <li class="mb-2">
                    ...
                    <span class="line-height-2 d-block overflow-hidden">{{strtoupper($devolucion->maquina->propietario->region->region)}}</span>
                  </li>
                </ul>
              </div>
            </div>
