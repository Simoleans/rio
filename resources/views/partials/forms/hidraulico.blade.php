          ...
          <div class="card-header">
           ...
           <div class="card-content">
            <div class="card-body">
              ...
              <textarea class="form-control" name="hidraulico_ob_bombas"></textarea>
            </div>
          ...
          <div class="card-header">
           ...
           <div class="card-content">
            <div class="card-body">
              ...
              <br>
              <small>Observacion</small>
              <textarea class="form-control" name="hidraulico_ob_tanque"></textarea>
            </div>
          ...
          <div class="card-header">
           ...
           <div class="card-content">
            <div class="card-body">
              ...
              <br>
              <small>Observacion</small>
              <textarea class="form-control" name="hidraulico_ob_tapon"></textarea>
            </div>
          ...
          <div class="card-header">
           ...
           <div class="card-content">
            <div class="card-body">
              ...
              <br>
              <small>Observacion</small>
              <textarea class="form-control" name="hidraulico_ob_visor"></textarea>
            </div>
          ...
          <div class="card-header">
           ...
           <div class="card-content">
            <div class="card-body">
              ...
              <br>
              <small>Observacion</small>
              <textarea class="form-control" name="hidraulico_ob_filtro_primario"></textarea>
            </div>
          ...
          <div class="card-header">
           ...
           <div class="card-content">
            <div class="card-body">
              ...
              <br>
              <small>Observacion</small>
              <textarea class="form-control" name="hidraulico_ob_filtro_secundario"></textarea>
            </div>
  ...
  <div class="row">
    <div class="col-md-12">
       <div class="card card-outline-info text-center box-shadow-0">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">Cilindros Fugas</h4>
          </div>
           <div class="card-content">
            <div class="card-body">
              <div class="container">
              ...
              <br>
              <small>Observacion</small>
              <textarea class="form-control" name="hidraulico_ob_cilindros_fuga"></textarea>
            </div>
  ...
  <div class="row">
    <div class="col-md-12">
       <div class="card card-outline-info text-center box-shadow-0">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title">Cilindros Sellos</h4>
          </div>
           <div class="card-content">
            <div class="card-body">
              <div class="container">
              ...
              <br>
              <small>Observacion</small>
              <textarea class="form-control" name="hidraulico_cilindros_ob_sellos"></textarea>
            </div>
