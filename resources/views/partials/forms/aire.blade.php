          ...
          <div class="card-header">
           ...
           <div class="card-content">
            <div class="card-body">
              ...
              <textarea class="form-control" name="air_ob_filtro_pri"></textarea>
            </div>
          ...
          <div class="card-header">
           ...
           <div class="card-content">
            <div class="card-body">
              ...
              <br>
              <small>Observacion</small>
              <textarea class="form-control" name="air_ob_filtro_sec"></textarea>
            </div>
          ...
          <div class="card-header">
           ...
           <div class="card-content">
            <div class="card-body">
              ...
              <br>
              <small>Observacion</small>
              <textarea class="form-control" name="air_ob_portafiltro"></textarea>
            </div>
            <!--  <input type="button" name="next" class="next btn btn-info" value="Confirmar"/> -->
          </div>
        </div>
