           ...
           <tr>
              <td class="text-center">{{$a->fruta->nombre_fruta}}</td>
             	...
             	<td class="text-center">
             		...
             		<a href="{{route('variedad.edit',['id' => $a->id])}}" class="btn btn-raised btn-warning btn-min-width mr-1 mb-1"><i class="fa fa-edit" title="Editar"></i></a>
                <a data-id="{{$a->id}}" class="btn btn-raised btn-danger btn-min-width mr-1 mb-1 delete" data-url="{{route('variedad.destroy',['id' => $a->id])}}"><i class="fa fa-trash" title="Eliminar"></i></a>
             	</td>
           </tr>
	        @endforeach
          </tbody>
